<template>
  <q-page class="bg-gray-100 dark:bg-gray-800 h-screen overflow-auto relative">
    <div class="min-h-full">
      <nav class="bg-gray-800">
              ...
              <div class="hidden md:block">
                <div class="ml-10 flex items-baseline space-x-4">
                  ...
                  <router-link to="/dashboard"
                    class="text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium" aria-current="page">
            ...
            <div class="hidden md:block">
              ...
              -->
                  <div v-if="menu"
                    ...
                    <a @click.prevent="logout" class="block cursor-pointer px-4 py-2 text-sm text-gray-700"
        ...
        <div class="md:hidden" id="mobile-menu">
          <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <router-link to="/dashboard" class="text-white hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium"
              aria-current="page">Dashboard</router-link>

            <router-link to="/blog"
              class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Blog
            </router-link>
          ...
          <div class="pt-4 pb-3 border-t border-gray-700">
            ...
            <div v-if="menu" class="mt-3 px-2 space-y-1">
              ...
              <a @click.prevent="logout"
                class="block px-3 cursor-pointer py-2 rounded-md text-base font-medium text-gray-400 hover:text-white hover:bg-gray-700">Sign
                out</a>
            </div>
          </div>
        </div>
      ...
      <footer class="d-footer items-center p-4 bg-neutral text-neutral-content">
